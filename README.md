...
src/
  ...
  scheduler.py  — проактивные сообщения (APScheduler cron 10:00)
tests/
  test_prompt.py
  test_bas.py
  test_context.py
...
- **Проактивные напоминания** — каждый день в 10:00 проверяет клиентов у которых подходит время повторного заказа
